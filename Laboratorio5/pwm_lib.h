 ...
 * Created: 2024
 * Author: [Tu nombre]
 * Description: Librería propia para el control de PWM mediante el Timer1
 *              del ATmega328P. Genera señal PWM de 50Hz (periodo 20ms)
 *              compatible con servomotores estándar.
 *              Rango de pulso: 1ms (0°) a 2ms (180°)
 */
 ...
 */
#define SERVO_MIN       2000    // Pulso de 1ms  = posición 0°
#define SERVO_MAX       4000    // Pulso de 2ms  = posición 180°
